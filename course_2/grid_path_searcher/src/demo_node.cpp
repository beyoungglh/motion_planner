...
/**
 * @brief rcvWaypointsCallback 接收目标点同时规划路径
 * @param wp
 */
void rcvWaypointsCallback(const nav_msgs::Path & wp)
{     
...
/**
 * @brief rcvPointCloudCallBack 存储地图
...
{   
    ...
    {    
        ...
        // set obstalces into grid map for path planning  存储栅格地用来规划
    ...
    pcl::toROSMsg(cloud_vis, map_vis);  //可视化
